...
The 'control_de_calidad_en_manufactura' project was generated by using the lakeflow-pipelines template.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] control_de_calidad_en_manufactura_etl` to your workspace.
